...
def main():
    ...
    while(nEq4>0 and len(pizzas)>=4):
        ...
        pizza0,pizza1,pizza2,pizza3=mejorComb4(pizzas, min(len(pizzas),22))
    ...
    while(nEq3>0 and len(pizzas)>=3):
        ...
        #Le pasamos las N primeras a probar
        pizza0,pizza1,pizza2=mejorComb3(pizzas, min(len(pizzas),32))
    ...
    while(nEq2>0 and len(pizzas)>=2):
        ...
        #Le pasamos las N primeras a probar
        pizza0,pizza1=mejorComb2(pizzas, min(len(pizzas),32))
