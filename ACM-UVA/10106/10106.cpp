...
{ 
  ...
  #ifndef ONLINE_JUDGE 
          close (0); open ("10106.in", O_RDONLY); 
          close (1); open ("10106.out", O_WRONLY | O_CREAT, 0600); 
  #endif 
  bignum a,b;
  
  while(cin.getline(a.digits,20000,'\n'))
  {
        
        bignum c;
        initialize_bignum(&c);
        cin.getline(b.digits,20000,'\n');
