...
def med_subtract( indata, dateinfo, kern_sz = 25 ):
    ...
    for i in range( numfiles ):
        ...
        outname='./C2DATA/'+dateinfo[i].strftime('%Y%m%d_%H%M_C2_medfilt.png')
...
def c2_process( rundiff=False ):

    # Gather list of file names
    lasco_files = sorted(glob.glob('./C2DATA/*.fts'))
    ...
    if rundiff:
        ...
        _ = med_subtract( data_cube, dates_times )